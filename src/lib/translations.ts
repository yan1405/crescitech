...
const translations = {
    pt: {
        ...
        blogPage: {
            title: "Blog",
            subtitle: "Insights, tendências e guias práticos sobre inteligência artificial, gestão e transformação digital.",
        ...
        blogPosts: {
            "como-ia-transforma-pequenas-empresas-2026": {
            ...
            "5-erros-comuns-ao-implementar-ia": {
            ...
            "automacao-processos-sem-programar": {
            ...
            "chatbots-com-ia-atendimento-247": {
            ...
            "ia-no-marketing-sem-perder-autenticidade": {
            ...
            "futuro-da-ia-nas-empresas-2027": {
    ...
    en: {
        ...
        blogPage: {
            title: "Blog",
            subtitle: "Insights, trends and practical guides on artificial intelligence, management and digital transformation.",
        ...
        blogPosts: {
            "como-ia-transforma-pequenas-empresas-2026": {
                ...
                summary: "Discover the key artificial intelligence trends accessible to SMEs and how to apply them today.",
                category: "Digital Transformation",
                readingTime: "6 min",
            },
            "5-erros-comuns-ao-implementar-ia": {
                title: "5 common mistakes when implementing AI in your business",
                summary: "Avoid the main mistakes that make companies lose money on technology projects without strategy.",
                category: "Management",
                readingTime: "5 min",
            },
            "o-que-e-o-modelo-6c": {
                title: "What is the 6C Model and why does it work?",
                summary: "Discover Crescitech's exclusive methodology that ensures a structured digital maturity journey.",
                category: "Model 6C",
                readingTime: "7 min",
            },
            "automacao-processos-sem-programar": {
                title: "Automate processes without coding: the best no-code tools",
                summary: "Discover the platforms that allow you to create powerful automations without writing a single line of code.",
                category: "Automations",
                readingTime: "8 min",
            },
            "chatbots-com-ia-atendimento-247": {
                title: "AI Chatbots: how to have 24/7 support without hiring more people",
                summary: "Learn how to implement an intelligent chatbot that actually solves your customers' problems.",
                category: "Tools",
                readingTime: "6 min",
            },
            "analise-preditiva-para-pmes": {
                title: "Predictive analytics for small businesses: from data to decision",
                summary: "How to use your own data to predict trends and make better decisions without needing a data scientist.",
                category: "AI Today",
                readingTime: "7 min",
            },
            "ia-no-marketing-sem-perder-autenticidade": {
                title: "AI in digital marketing: how to use it without losing authenticity",
                summary: "Practical strategies for using artificial intelligence in marketing without sounding robotic or generic.",
                category: "Tools",
                readingTime: "6 min",
            },
            "futuro-da-ia-nas-empresas-2027": {
                title: "The future of AI in business: what to expect for 2027",
                summary: "An analysis of the trends that will shape how companies use artificial intelligence in the coming years.",
                category: "Future",
                readingTime: "8 min",
            },
            "como-treinar-equipe-para-ia": {
                title: "How to train your team to use AI without resistance",
                summary: "Practical strategies to engage employees in the adoption of artificial intelligence tools.",
                category: "Management",
                readingTime: "6 min",
            },
            "como-medir-roi-projetos-ia": {
                title: "How to measure the ROI of AI projects in your company",
                summary: "Practical metrics and frameworks to prove (or disprove) whether your AI investments are paying off.",
                category: "AI Today",
                readingTime: "7 min",
            },
        },
        ...
        resources: {
            "template-prompts-pmes": {
                title: "Template: 50 ready-to-use prompts for SMEs",
                description: "A collection of tested and optimized prompts to use in ChatGPT, Claude and other AIs in the context of small and medium-sized businesses.",
                category: "Tools",
                highlights: [
    ...
    fr: {
        ...
        blogPage: {
            title: "Blog",
            subtitle: "Insights, tendances et guides pratiques sur l'intelligence artificielle, la gestion et la transformation numérique.",
        ...
        blogPosts: {
            "como-ia-transforma-pequenas-empresas-2026": {
                title: "Comment l'IA transforme les petites entreprises en 2026",
                summary: "Découvrez les principales tendances de l'intelligence artificielle accessibles aux PME et comment les appliquer aujourd'hui.",
                category: "Transformation Numérique",
                readingTime: "6 min",
            },
            "5-erros-comuns-ao-implementar-ia": {
                title: "5 erreurs courantes lors de la mise en œuvre de l'IA dans votre entreprise",
                summary: "Évitez les principales erreurs qui font perdre de l'argent aux entreprises dans des projets technologiques sans stratégie.",
                category: "Gestion",
                readingTime: "5 min",
            },
            "o-que-e-o-modelo-6c": {
                title: "Qu'est-ce que le Modèle 6C et pourquoi fonctionne-t-il ?",
                summary: "Découvrez la méthodologie exclusive de Crescitech qui garantit un parcours de maturité numérique structuré.",
                category: "Modèle 6C",
                readingTime: "7 min",
            },
            "automacao-processos-sem-programar": {
                title: "Automatisez des processus sans savoir coder : les meilleurs outils no-code",
                summary: "Découvrez les plateformes qui permettent de créer des automatisations puissantes sans écrire une seule ligne de code.",
                category: "Automatisations",
                readingTime: "8 min",
            },
            "chatbots-com-ia-atendimento-247": {
                title: "Chatbots IA : comment avoir un support 24/7 sans recruter plus de personnes",
                summary: "Apprenez à mettre en place un chatbot intelligent qui résout vraiment les problèmes de vos clients.",
                category: "Outils",
                readingTime: "6 min",
            },
            "analise-preditiva-para-pmes": {
                title: "Analyse prédictive pour les petites entreprises : de la donnée à la décision",
                summary: "Comment utiliser vos propres données pour prévoir les tendances et prendre de meilleures décisions sans avoir besoin d'un data scientist.",
                category: "IA Aujourd'hui",
                readingTime: "7 min",
            },
            "ia-no-marketing-sem-perder-autenticidade": {
                title: "L'IA dans le marketing digital : comment l'utiliser sans perdre l'authenticité",
                summary: "Stratégies pratiques pour utiliser l'intelligence artificielle dans le marketing sans paraître robotique ou générique.",
                category: "Outils",
                readingTime: "6 min",
            },
            "futuro-da-ia-nas-empresas-2027": {
                title: "L'avenir de l'IA en entreprise : qu'attendre pour 2027",
                summary: "Une analyse des tendances qui façonneront la façon dont les entreprises utiliseront l'intelligence artificielle dans les années à venir.",
                category: "Avenir",
                readingTime: "8 min",
            },
            "como-treinar-equipe-para-ia": {
                title: "Comment former votre équipe à utiliser l'IA sans résistance",
                summary: "Stratégies pratiques pour engager les collaborateurs dans l'adoption des outils d'intelligence artificielle.",
                category: "Gestion",
                readingTime: "6 min",
            },
            "como-medir-roi-projetos-ia": {
                title: "Comment mesurer le ROI des projets IA dans votre entreprise",
                summary: "Métriques et frameworks pratiques pour prouver (ou réfuter) si vos investissements en IA en valent la peine.",
                category: "IA Aujourd'hui",
                readingTime: "7 min",
            },
        },
        ...
        resources: {
            "template-prompts-pmes": {
                title: "Template : 50 prompts prêts à l'emploi pour les PME",
                description: "Une collection de prompts testés et optimisés à utiliser dans ChatGPT, Claude et autres IA dans le contexte des petites et moyennes entreprises.",
                category: "Outils",
                highlights: [
                    "50 prompts organisés par catégorie",
